    ...
    () => [
      {
        ...
        initFunc: ({ $props, $state, $queries, $ctx }) => $props.hasSplit
      },

      {
        ...
        type: "private",
        variableType: "variant",
        initFunc: ({ $props, $state, $queries, $ctx }) => $props.isIcon
      },

      {
        ...
        type: "private",
        variableType: "variant",
        initFunc: ({ $props, $state, $queries, $ctx }) => $props.isPrimary
      },
        ...
        <p.Stack
          ...
          className={classNames(projectcss.all, sty.button2, {
            ...
            [sty.button2isIcon_isPrimary]:
              hasVariant($state, "isPrimary", "isPrimary") &&
              hasVariant($state, "isIcon", "isIcon"),
            [sty.button2isPrimary]: hasVariant(
              $state,
              "isPrimary",
              "isPrimary"
            ),
            [sty.button2radius_large]: hasVariant($state, "radius", "large"),
            [sty.button2radius_small]: hasVariant($state, "radius", "small")
          })}
        >
          {p.renderPlasmicSlot({
            defaultContents: (
