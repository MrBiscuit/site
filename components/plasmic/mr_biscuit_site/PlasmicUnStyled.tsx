...
export type PlasmicUnStyled__ArgsType = {
  ...
  tempStarScore?: number;
  onTempStarScoreChange?: (val: number) => void;
  realStarScore?: number;
  onRealStarScoreChange?: (val: number) => void;
};
...
export const PlasmicUnStyled__ArgProps = new Array<ArgPropType>(
  "children",
  "tempStarScore",
  "onTempStarScoreChange",
  "realStarScore",
  "onRealStarScoreChange"
);
...
function PlasmicUnStyled__RenderFunc(props: {
  ...
  const stateSpecs = React.useMemo(
    () => [
      ...
      {
        path: "unstyledSegemented.current",
        type: "private",
        variableType: "number",
...

      {
        ...
        valueProp: "tempStarScore",
        onChangeProp: "onTempStarScoreChange"
      },
      {
        path: "realStarScore",
        type: "writable",
        ...
        valueProp: "realStarScore",
        onChangeProp: "onRealStarScoreChange"
      },
      {
        path: "unstyledRate.numberOfStars",
        type: "private",
        variableType: "number",
        initFunc: ({ $props, $state, $queries, $ctx }) => 5 as const
      },

      {
        path: "unstyledRate.score",
        type: "private",
        variableType: "number",
                ...
                {true ? (
                  ...
                  >
                    <UnstyledSegemented
                      ...
                      onCurrentChange={p.generateStateOnChangeProp($state, [
                        "unstyledSegemented",
                        "current"
                      ])}
                    />
                    ...
                    {true ? (
                      ...
                      >
                        ...
                        {true ? (
                          <div
                            ...
                            onMouseOut={async event => {
                              ...
                              $steps["setTempStarScore"] = true
                                      ...
                                      variable: __wrapUserFunction(
                                        {
                                          ...
                                          interactionUuid: "mOwmWmLZ1",
                                          componentUuid: "0VvvxOmc0M",
                                          argName: "variable"
                                        },
                                        () => ({
                                          objRoot: $state,
                                          variablePath: ["tempStarScore"]
                                        })
                                      ),
                                ...
                                : undefined;
                              if (
                                typeof $steps["setTempStarScore"] ===
                                  "object" &&
                                typeof $steps["setTempStarScore"].then ===
                                  "function"
                              ) {
                                $steps["setTempStarScore"] =
                          ...
                          >
                            <Rate
                              ...
                              onNumberOfStarsChange={p.generateStateOnChangeProp(
                                $state,
                                ["unstyledRate", "numberOfStars"]
                              )}
                              onScoreChange={p.generateStateOnChangeProp(
                                $state,
                                ["unstyledRate", "score"]
                              )}
                            />
                        ...
                        >
                          {(() => {
                            try {
                              return $state.unstyledRate.score + 1 + ".0";
                            } catch (e) {
