...
import sty from "./PlasmicButton2.module.css"; // plasmic-import: Ahr29ahuyJW/css

import ChecksvgIcon from "../pro_layout_panel_landing_pgae/icons/PlasmicIcon__Checksvg"; // plasmic-import: r_TPt86vHV4SXb/icon
import Icon61Icon from "./icons/PlasmicIcon__Icon61"; // plasmic-import: _2Xgt3HUXgn/icon
      ...
      {(hasVariant($state, "showStartIcon", "showStartIcon") ? true : false) ? (
        ...
        >
          {p.renderPlasmicSlot({
            defaultContents: (
              <ChecksvgIcon
                className={classNames(projectcss.all, sty.svg___4GnxR)}
                role={"img"}
              />
            ),
      ...
      {(hasVariant($state, "showEndIcon", "showEndIcon") ? true : false) ? (
        ...
        >
          {p.renderPlasmicSlot({
            defaultContents: (
              <Icon61Icon
                className={classNames(projectcss.all, sty.svg__zieq3)}
                role={"img"}
              />
            ),
