...
import sty from "./PlasmicIconLink.module.css"; // plasmic-import: 1VSJl1M4qMed7Q/css
    ...
    >
      ...
      >
        {p.renderPlasmicSlot({
          defaultContents: (
            <svg
              className={classNames(projectcss.all, sty.svg__vKccV)}
              role={"img"}
            />
          ),
